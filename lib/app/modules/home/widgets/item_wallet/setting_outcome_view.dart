...
class SettingOutComeView extends StatelessWidget {
  const SettingOutComeView({Key? key}) : super(key: key);
            ...
            Stack(
              children: [
                Positioned(
                  ...
                  child: Bounceable(
                    onTap: () {
                      controller.isChosenDragOutcome = true.obs;
                      controller.update();
                    },
                    child: Container(
                      height: 60,
                      ...
                      decoration: BoxDecoration(
                          image: controller.outComeChosenImage != ''.obs
                              ? DecorationImage(
                                  image: AssetImage(
                                      controller.outComeChosenImage.value))
                              : null,
                    ...
                    children: [
                      Container(
                        ...
                        child: ItemButtonW700(
                            ...
                            onTap: () {
                              controller.isDetailOutcome = false.obs;
                              controller.update();
                            }),
                      ),
                    ],
